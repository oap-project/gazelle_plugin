...
class Orc_TPCDSSuite extends QueryTest with SharedSparkSession {

  private val MAX_DIRECT_MEMORY = "6g"
  private val TPCDS_QUERIES_RESOURCE = "tpcds"
  private val TPCDS_WRITE_PATH = "/tmp/orc_tpcds-generated"
  ...
  override def afterAll(): Unit = {TPCDSSuite
    super.afterAll()
  }
