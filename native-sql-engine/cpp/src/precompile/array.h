   ...
   public:                                                              \
    ...
    arrow::util::string_view GetView(int64_t i) const {                 \
      ...
      return arrow::util::string_view(                                  \
          reinterpret_cast<const char*>(raw_value_ + pos),              \
...
class Decimal128Array : public FixedSizeBinaryArray {
 public:
  Decimal128Array(const std::shared_ptr<arrow::Array>& in)
      : FixedSizeBinaryArray(in) {}
...
arrow::Status MakeFixedSizeBinaryArray(
    const std::shared_ptr<arrow::FixedSizeBinaryType>&, int64_t,
