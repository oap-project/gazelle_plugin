...
TEST(TestArrowCompute, AggregateTest) {
  ...
  auto n_action =
      TreeExprBuilder::MakeFunction("aggregateActions",
                                    {n_sum, n_count, n_sum_count, n_avg, n_min, n_max,
                                     n_stddev, n_count_literal, n_min_str, n_max_str},
                                    uint32());
  ...
  std::vector<std::shared_ptr<Field>> ret_types = {
      ...
      f_max, f_stddev, f_count_literal, f_min_str, f_max_str};
  ///////////////////// Calculation //////////////////
...
TEST(TestArrowCompute, GroupByAggregateTest) {
  ...
  std::vector<std::string> expected_result_string = {
      ...
      "[16.4, 6.5, 5, 5.875, 5.48, null, 6.1, 6.619047619047619, 3.0625, "
      "2.638888888888889, "
      "2.066666666666667]",
      "[8.492553019565051, 6.931367805067252, 7.648904962570575, 13.570764059328763, "
      "17.466813592401582, "
      "1.4142135623730951, 8.527788283128372, 6.236331106499947, "
      "5.589028976303414, "
