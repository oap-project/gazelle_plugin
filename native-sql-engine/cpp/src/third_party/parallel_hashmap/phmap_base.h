...
struct is_detected_convertible_impl<
    typename std::enable_if<std::is_convertible<Op<Args...>, To>::value>::type, To, Op,
    Args...> {
  using type = std::true_type;
};
...
template <size_t Len,
          size_t Align =
              type_traits_internal::default_alignment_of_aligned_storage<Len>::value>
...
// ----------------------------------------------------------------------
#if defined(_MSC_VER) || \
    (defined(_LIBCPP_VERSION) && _LIBCPP_VERSION < 4000 && _LIBCPP_STD_VER > 11)
...
struct IsHashable<
    Key, phmap::enable_if_t<std::is_convertible<decltype(std::declval<std::hash<Key>&>()(
...
struct AssertHashEnabledHelper {
 private:
  ...
  static std::nullptr_t DoIt() {
    ...
    static_assert(
        std::is_same<ReturnType, NAT>::value || std::is_same<ReturnType, size_t>::value,
...
struct hash_policy_traits {
 ...
 private:
  ...
  template <class Alloc>
  static void transfer_impl(Alloc* alloc, slot_type* new_slot, slot_type* old_slot,
                            char) {
...
struct Callable {
  ...
  static decltype(std::declval<F>()(std::declval<Args>()...)) Invoke(F&& f,
                                                                     Args&&... args) {
...
#pragma warning(push)
#pragma warning( \
    disable : 4365)  // '=': conversion from 'T' to 'T', signed/unsigned mismatch
#endif               // _MSC_VER
...
template <typename T, typename... Args>
typename memory_internal::MakeUniqueResult<T>::invalid make_unique(Args&&... /* args */) =
    delete;
#endif
...
struct pointer_traits {
  ...
  using difference_type = memory_internal::ExtractOrT<memory_internal::GetDifferenceType,
                                                      Ptr, std::ptrdiff_t>;
...
struct allocator_traits {
  ...
  using pointer =
      memory_internal::ExtractOrT<memory_internal::GetPointer, Alloc, value_type*>;

  // const_pointer:
  // Alloc::const_pointer if present, otherwise
  // phmap::pointer_traits<pointer>::rebind<const value_type>
  using const_pointer = memory_internal::ExtractOrT<
      memory_internal::GetConstPointer, Alloc,
  ...
  using size_type =
      memory_internal::ExtractOrT<memory_internal::GetSizeType, Alloc,
  ...
  using propagate_on_container_copy_assignment =
      memory_internal::ExtractOrT<memory_internal::GetPropagateOnContainerCopyAssignment,
  ...
  using propagate_on_container_move_assignment =
      memory_internal::ExtractOrT<memory_internal::GetPropagateOnContainerMoveAssignment,
                                  Alloc, std::false_type>;

  // propagate_on_container_swap:
  // Alloc::propagate_on_container_swap if present, otherwise std::false_type
  using propagate_on_container_swap =
      memory_internal::ExtractOrT<memory_internal::GetPropagateOnContainerSwap, Alloc,
                                  std::false_type>;
...
struct is_constructible_convertible_assignable_from_optional
    : std::integral_constant<bool,
                             is_constructible_convertible_from_optional<T, U>::value ||
 ...
 public:
  ...
  template <
      ...
      typename std::enable_if<
          phmap::conjunction<
              phmap::negation<std::is_same<in_place_t, typename std::decay<U>::type>>,
  ...
  template <
      ...
      typename std::enable_if<
          phmap::conjunction<
              ...
              phmap::negation<
                  optional_internal::is_constructible_convertible_from_optional<T, U>>,
  ...
  template <
      ...
      typename = typename std::enable_if<phmap::conjunction<
          ...
          phmap::negation<
              optional_internal::is_constructible_convertible_assignable_from_optional<
                  T, U>>>::value>::type>
...
#pragma warning(disable : 4702)
  ...
  T&& value() && {  // NOLINT(build/c++11)
    return std::move(static_cast<bool>(*this)
                         ? reference()
                         : (optional_internal::throw_bad_optional_access(), reference()));
  }
 ...
 public:
  ...
  constexpr reference at(size_type i) const {
    return PHMAP_PREDICT_TRUE(i < size())  //
               ? *(data() + i)
               : (base_internal::ThrowStdOutOfRange("Span::at failed bounds check"),
                  *(data() + i));
  }
...
using LayoutType =
    LayoutImpl<std::tuple<Ts...>, phmap::make_index_sequence<NumSizes>,
