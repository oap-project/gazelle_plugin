...
class FloatTypeDataFiberReaderWriterSuite extends DataFiberReaderWriterSuite {
  ...
  test("no dic no nulls") {
    // write data
    val column = new OapOnHeapColumnVector(total, FloatType)
