 ...
 */
public class SparkManagedReservationListener extends MemoryConsumer implements ReservationListener {

    public SparkManagedReservationListener(TaskMemoryManager taskMemoryManager) {
