...
/**
  ...
  * [[WritablePartitionedPairCollection]], [[PartitionedPairBuffer]] and
  ...
  */
private[spark] class RPartitionedPairBuffer[K, V](initialCapacity: Int = 64)
    extends RWritablePartitionedPairCollection[K, V] with SizeTracker
{
  import RPartitionedPairBuffer._
