...
private[spinach] object CacheStatusSerDe extends SerDe[String, Seq[FiberCacheStatus]] {
  ...
  private[spinach] def dataFileMetaToJson(dataFileMeta: SpinachDataFileHandle): JValue = {
  ...
  private[spinach] def dataFileMetaFromJson(json: JValue): SpinachDataFileHandle = {
